            ...
            >
                {movies.map((movie) => (
                    <SwiperSlide key={movie._id}>
                        ...
                        <Link href={`/phim/${movie.slug}`} className="block group">
                            ...
                            >
                                <Image
                                    ...
                                    className="rounded-lg w-full lg:h-[220px] aspect-video"
                                />
                                <div className="absolute bottom-0 left-4 w-full flex">
                                    <span className="bg-white font-medium rounded-t-md text-black text-[11px] px-2 py-1">
                                        Sắp chiếu
                                    </span>
                            ...
                            <div className="px-4  mt-2 flex-grow min-w-0">
