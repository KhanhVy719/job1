...
var snowStorm = (function(window, document) {
    ...
    this.autoStart = true;
    this.excludeMobile = false;     // <--- SỬA DÒNG NÀY THÀNH FALSE
    this.flakesMax = 128;
    this.flakesMaxActive = 20;
    this.animationInterval = 40;
    this.useGPU = true;
    this.className = null;
    this.excludeMobile = false;     // <--- SỬA DÒNG NÀY THÀNH FALSE (Code gốc bị lặp lại dòng này, sửa cả 2 cho chắc)
    this.flakeBottom = null;        // Integer for Y axis snow limit, 0 or null for "full-screen" snow effect
    this.followMouse = true;        // Snow movement can respond to the user's mouse
    this.snowColor = '#fff';        // Don't eat (or use?) yellow snow.
    this.snowCharacter = '<img src="/events/snow1.png" />';  // &bull; = bullet, &middot; is square on some systems etc.
