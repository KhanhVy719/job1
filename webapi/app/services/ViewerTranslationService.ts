...
const CATEGORY_NAMES: Record<ViewerLanguageCode, Record<string, string>> = {
  en: {
    ...
    "phim-nhac": "Music",
    "lich-su": "History",
    "phim-lich-su": "History",
    "mien-tay": "Western",
    "phim-mien-tay": "Western",
  ...
  fil: {
    ...
    "phim-nhac": "Musika",
    "lich-su": "Kasaysayan",
    "phim-lich-su": "Kasaysayan",
    "mien-tay": "Western",
    "phim-mien-tay": "Western",
    "action-and-adventure": "Aksyon at Pakikipagsapalaran",
    "sci-fi-and-fantasy": "Sci-Fi at Fantasy",
    "war-and-politics": "Digmaan at Pulitika",
    "phim-than-thoai": "Mythology",
