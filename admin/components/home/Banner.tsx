    ...
    <div className="relative w-full  text-white overflow-hidden">
            ...
            {({ isActive }) => (
              <div className="relative w-full h-full overflow-hidden">
                <div className="absolute inset-0 z-0 overflow-hidden">
                  ...
                  <div className="  before:absolute  before:inset-0  before:bg-[url('/images/dotted.png')]  before:bg-repeat  before:opacity-20  before:z-10 before:content-['']"></div>
                  ...
                  <div className="relative z-[10] top-[-3rem]  lg:top-8 flex justify-center lg:justify-start items-center h-full  w-full px-5 sm:px-8 lg:px-10">
                    <div
                    ...
                    >
                      ...
                      <div className="flex items-center lg:ml-0 ml-12 justify-center lg:block w-[13rem] md:w-[23rem] lg:w-[30rem]">
                        <Image
                      ...
                      <h3 className="text-sm text-primary opacity-80 text-center lg:text-left">{movie.alias}</h3>

                      <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 text-[13px]">
                        {movie.imdb && <span className="text-primary border border-primary font-bold px-2 py-0.5 rounded">IMDb {movie.imdb}</span>}
                        {movie.quality && <span className="bg-[linear-gradient(220deg,rgb(var(--primary)),rgb(var(--primary-light)/1))] text-black font-bold px-2 py-0.5 rounded">{movie.quality}</span>}
                      ...
                      <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2">
                        {movie.genres.map((genre, i) => (
                          <Link href="#" key={i} className="text-xs bg-white/10 hover:text-primary px-2 py-1 rounded transition-colors">
                            {genre}
                          </Link>
                        ))}
                      </div>
                      ...
                      <div className="pt-3 hidden items-center gap-4 md:flex">
      ...
      >
        <Swiper
          ...
          className="top-slide-small lg:w-[550px] w-full flex"
        >
          {movies.map((movie, index) => (
