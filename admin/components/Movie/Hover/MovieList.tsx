...
interface Movie {
    ...
    imageUrl: string;
    badge?: string;
     badgeFB?: string; // Mới: e.g., "FB: 4"
  badgeTM?: string; // Mới: e.g., "TM: 4"
  episodeInfo?: string; // Mới: e.g., "T18 | Phần 1 | Tập 4"
}
...
function MovieListHover({
    ...
    let top = position.top - 200;

    if (left < 0) left =  position.left - 120;
    if (left + cardWidth > screenWidth) left =  position.left -260;
