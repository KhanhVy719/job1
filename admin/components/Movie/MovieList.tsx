  ...
  return (
    <div className="relative w-full ">
      <Swiper
        ...
        className="mySwiper"
        breakpoints={{
          0: { slidesPerView: 3.2,spaceBetween:7 },      // Mobile
          480: { slidesPerView: 2.2 ,spaceBetween:10 },    // Small tablet
          640: { slidesPerView: 3.5,spaceBetween:15  },    // Tablet
          768: { slidesPerView: 5 ,spaceBetween:17},    // Laptop nhỏ
          1024: { slidesPerView: 6,spaceBetween:17 },   // Laptop lớn
          1280: { slidesPerView: 7,spaceBetween:17 },   // PC lớn
        }}
        onTouchStart={() => {
          setIsDragging(true);
          immediateHide();
            ...
            <Link href="/" className="flex flex-col h-full">
              ...
              >
                <Image
                  ...
                  className="rounded-xl w-full max-h-[500px] xl:min-h-[300px] h-full"
                />
              ...
              <div className="md:px-4 mt-2 text-center">
                ...
                <p className="text-[11px] lg:text-xs mt-1.5 text-gray-400">{movie.subtitle}</p>
              </div>
            </Link>
          </SwiperSlide>
        ))}
