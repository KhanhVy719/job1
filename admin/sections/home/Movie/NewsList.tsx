...
const MovieShelf = dynamic(() => import("@/components/Movie/MovieShelf"), {
  ssr: false,
});
const film = [
...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className='flex items-center space-x-2 text-lg lg:text-xl xl:text-2xl mt-16'>
        <span className='font-semibold text-white '>Mãn Nhãn với Phim Chiếu Rạp
        </span>
